...
open(f,">>P_R_F_score.txt");
print f "P_value-----------------------R_value------------------------F_value";
print f "\n";
...
sub MeasurePerformance
{
  ...
  print "current_answerset = ".$current_answerset."\n";
...
print f "[".uc($current_set)."] Match_Precision_Recall_Fscore\n";
...
print f "Top 05:\t".$matchNo5."\t".$Prec5b."\t".$Recall5b."\t".$Fscore5b."\n";
print f "Top 10:\t".$matchNo10."\t".$Prec10b."\t".$Recall10b."\t".$Fscore10b."\n";
print f "Top 15:\t".$matchNo15."\t".$Prec15b."\t".$Recall15b."\t".$Fscore15b."\n";
print f "\n";
}
close f;
